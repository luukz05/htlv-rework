    ...
    <main className="mx-auto max-w-[440px] px-5 py-16">
      <div className="rounded-xl border border-border bg-bg-card p-8 card-glow animate-fade-in-up">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-6">
          <button className="flex items-center justify-center gap-2 rounded-lg border border-border bg-bg-surface px-2 sm:px-4 py-2.5 text-sm font-medium text-text-secondary hover:border-border-hover hover:text-text-primary transition-colors">
